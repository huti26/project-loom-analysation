...
data <- subset(data, data$runs == 1000)
...
data.1000 <- subset(data, data$requests == 1000)
...
ggsave(plot=scatter_plot_1000,"./Footprint/scatter_plot_1000.png",width=8.17,height=6.5)
...
ggsave(plot=linreg_plot_1000,"./Footprint/linreg_plot_1000.png",width=8.17,height=6.5)
...
ggsave(plot=box_plot,"./Footprint/boxplot_1000.png",width=8.17,height=6.5)
