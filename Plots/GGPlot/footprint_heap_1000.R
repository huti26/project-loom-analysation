...
data.t <- read.csv("./Footprint/Megabytes/1000-1000-t.csv")
data.t$type <- "Thread"

data.vt <- read.csv("./Footprint/Megabytes/1000-1000-vt.csv")
data.vt$type <- "Virtual Thread"

data <- rbind(data.t, data.vt)
data$requests.char <- "1000 Requests"
...
ggsave(plot=g,"./Footprint/areaplot_heap_1000.png",width=8.17,height=6.5)
...
ggsave(plot=box_plot,"./Footprint/boxplot_heap_1000.png",width=8.17,height=6.5)
