...
data_t = pd.read_csv("../CSV/Megabytes/500-10000-t.csv")
data_vt = pd.read_csv("../CSV/Megabytes/500-10000-vt.csv")
...
plt.savefig("../Plots/heap_500_box.png", dpi=300, bbox_inches='tight')
