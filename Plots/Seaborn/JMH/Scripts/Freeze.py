...
# filter Benchmarks
data = data.loc[data['Benchmark'].str.contains("Freeze.justYield")]
...
g = sns.catplot(x="Param: paramCount", y="Score", hue="Benchmark", data=data,
                col="Param: stackDepth", col_wrap=4, kind="bar", sharey=True, legend=False)
...
plot_folder = "../Plots/"
plt.savefig(plot_folder + "Freeze.png", bbox_inches='tight')
